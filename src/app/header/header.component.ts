  ...
  async share() {
    try{
      await this.ngNavigatorShareService.share({
        title: "Torakis Ioannis Resume",
        text: "I'm a Full-stack .NET Software Engineer with 4+ years of experience designing web applications.",
        url: "https://torakisioannis.com"
      });
    } catch(error) {
